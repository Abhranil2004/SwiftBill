        ...
        <div className={heroStyles.grid}>
          ...
          <div className={heroStyles.content}>
            <div className={heroStyles.contentInner}>
              ...
              <div className={heroStyles.badge}>
                ...
                <span className={heroStyles.badgeText}>
                  Lightning Fast Invoicing Platform
                </span>
              </div>
              ...
              <p className={heroStyles.description}>
                Create professional invoices in a matter of seconds.{" "}
                <span className={heroStyles.descriptionHighlight}>
                  Easily enter details
                </span>{" "}
                and let our system calculate totals, format correctly, and generate
            ...
            <div className={heroStyles.featuresGrid}>
              {[
                { icon: "🛠️", label: "Easy to Use", desc: "Intuitive interface" },
                {
                  icon: "⚡",
                ...
                <div className={heroStyles.cardHeader}>
                  <div className="space-y-1">
                    <div className={heroStyles.cardLogoContainer}>
                      <div className={heroStyles.cardLogo}>SB</div>
                      <div>
